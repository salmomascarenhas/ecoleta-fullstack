...
const Detail = () => {
  ...
  function handleEmail() {
    Linking.openURL(`mailto:${data.point.email}?subject=Coleta de Resíduos`);
  }

  function handleWhatsapp() {
    Linking.openURL(`whatsapp://send?phone=${data.point.whatsapp}&text=Gostaria de mais informações sobre a coleta de resíduos.`)
  }
